                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align">
                                    <strong class="card-title">Perlu dikirim</strong>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td> <span
                                                        class="badge badge-danger p-2">{{ $item->status_pengiriman }}</span>
                                                </td>
                                                <td>
                                                    <a href="{{ route('kurir.kirimBarang', $item->id) }}"
                                                        class="btn btn-sm btn-primary">
                                                        <i class="ti ti-truck mr-2"></i>Kirim Barang
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align">
                                    <strong class="card-title">Sedang dikirim/dalam perjalanan</strong>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-2" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @php
                                            $i = 1;
                                        @endphp
                                        @foreach ($dalamPerjalanan as $item)
                                            <tr>
                                                <td>{{ $i++ }}</td>
                                                <td>{{ $item->kode_transaksi }}</td>
                                                <td>{{ $item->customer->nama_lengkap }}</td>
                                                <td>{{ $item->alamat_pengiriman }}</td>
                                                <td> <span
                                                        class="badge badge-warning p-2">{{ $item->status_pengiriman }}</span>
                                                </td>
                                                <td>
                                                    <a href="{{ route('kurir.selesaikanPengiriman', $item->id) }}"
                                                        class="btn btn-sm btn-success">
                                                        <i class="ti ti-check-box"></i> Selesaikan
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
