    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="orders">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title mb-5 text-center">Grafik Monitoring Pembayaran Order Barang
                                    </h4>
                                    <canvas id="statusBayarPie" width="250" height="300"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Tabel Monitoring Pembayaran Order Barang</h4>
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Pending</td>
                                                <td>{{ $statusBayar['pending'] }}</td>
                                            </tr>
                                            <tr>
                                                <td>Disetujui</td>
                                                <td>{{ $statusBayar['disetujui'] }}</td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                <th>Total Semua</th>
                                                <th>{{ array_sum($statusBayar) }}</th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                ...
                <script>
                    const labelsBayar = ['Pending', 'Disetujui'];
                    const dataBayar = @json(array_values($statusBayar));

                    const ctx2 = document.getElementById('statusBayarPie').getContext('2d');
                    new Chart(ctx2, {
                        type: 'bar',
                        data: {
                            labels: labelsBayar,
